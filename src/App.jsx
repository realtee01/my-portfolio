  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white font-sans selection:bg-blue-500/30">
      ...
      >
            ...
            <div className="max-w-3xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-20">
                <div className="p-6 bg-[#121212] border border-white/5 rounded-2xl">
                  ...
                  <h4 className="text-white font-bold text-lg text-nowrap">Frontend Engineering</h4>
                  <p className="text-gray-500 text-sm">Axia Africa • 6 Months</p>
                </div>
                ...
                <div className="p-6 bg-[#121212] border border-white/5 rounded-2xl">
                  ...
                  <p className="text-gray-500 text-sm">UNILAG • In View</p>
                </div>
              </div>
        ...
        {/* 3. FOOTER (Hidden until loading is done) */}
        {!isLoading && (
