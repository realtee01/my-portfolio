...
function App() {
  ...
  <p>
    I’m currently interning as a frontend developer and building my own projects on the side — <span className="text-blue-500">Cinescope</span>, a <span className="text-blue-500">Job Listings Board</span>, and <span className="text-blue-500">Forzchain</span>. I ship to Vercel and I’m always in the middle of learning something new.
  </p>
